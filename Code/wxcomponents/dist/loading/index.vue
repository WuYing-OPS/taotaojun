<template>
<uni-shadow-root class="dist-loading-index"><view :class="'container-loading l-container-class '+(fullScreen ? 'content': '')" v-if="show && fullScreen" :style="'background:'+(bgColor)+';opacity:'+(opacity)+';z-index:'+(zIndex)" @touchmove.stop.prevent="doNothingMove">
